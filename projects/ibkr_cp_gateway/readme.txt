...
But while building the RUNTIME_PATH, the script is using ":" as the path separator.
But we should use ";" instead. So changing
...
will fix it. I made the fix a bit generic and added it in this directory (under
./bin/run.sh)
-------------------------------------------------------------------------------
